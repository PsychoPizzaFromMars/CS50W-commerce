...
class AuctionListing(models.Model):
    ...
    cur_bid = models.ForeignKey(Bid, blank=True, null=True, on_delete=models.CASCADE, related_name="current_bid")
    item_image = models.URLField(blank=True)
    category = models.ForeignKey(Item_category, on_delete=models.CASCADE, related_name="listings")
...
class Comment(models.Model):
    ...
    commenter = models.ForeignKey(User, null=True, on_delete=models.CASCADE, related_name="users_comments")
